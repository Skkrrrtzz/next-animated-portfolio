    ...
    return (
        <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
            ...
            <div className="md:hidden lg:flex w-1/3 justify-center">
                <Link href="/" className="text-3xl bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent">
                    <span className="text-3xl font-bold">Kertz</span>
                </Link>
            </div>
            {/* Social Links */}
            <div className="hidden md:flex gap-4 w-1/3">
                <Link href="https://github.com/Skkrrrtzz">
                    <Image src="/github-mark-white.png" width={24} height={24} alt="Github" />
                </Link>
            ...
            <div className="md:hidden">
                ...
                {/* Menu Lists */}
                {open && (
                    <motion.div variants={listVariants} initial="closed" and animate="opened" className="absolute top-0 left-0 w-screen h-screen bg-black text-white flex flex-col items-center justify-center gap-8 text-4xl z-40">
                    {links.map((link) => (
